    ...
    <div className="flex items-center gap-3 p-2">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary text-primary-foreground">
        ...
        >
          ...
          <g fill="#ffffff">
            <rect width="160" height="40" fill="#00a99d" />
            <g fontFamily="Arial, sans-serif" fontWeight="bold">
              <text x="45" y="29" fontSize="24" fill="#ffffff">DDV</text>
              <g fontSize="10">
                <text x="95" y="17" fill="#ffffff">DEMENAGEMENT</text>
                <text x="95" y="30" fill="#ffffff">DU VEXIN</text>
              </g>
            </g>
          </g>
          <path
