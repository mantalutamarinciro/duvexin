...
const fallbackTestimonials: FormattedReview[] = [
  ...
  { id: "fallback-2", name: "David L.", text: "Très bonne expérience. Devis clair et service impeccable. Un déménagement sans stress, même avec des accès pas évidents. Le monte-meubles a tout sauvé ! Merci.", rating: 5, createTime: "il y a 8 mois", avatarUrl: `https://i.pravatar.cc/48?u=DavidL94A` },
  { id: "fallback-3", name: "Entreprise Connectis", text: "Le transfert de nos bureaux près de la Vache Noire a été une réussite. Une planification sans faille et une exécution rapide pour nos 50 collaborateurs.", rating: 5, createTime: "il y a 1 an", avatarUrl: `https://i.pravatar.cc/48?u=Connectis94` },
];
...
const WHY_US_ITEMS = [
  ...
  },
  {
    ...
    description: "Nous gérons pour vous les demandes d'autorisation de stationnement en mairie, une démarche souvent complexe à Arcueil."
  }
];
...
const FAQS = [
  ...
  { question: "Vous occupez-vous des déménagements d'entreprises près de la Vache Noire ?", answer: "Oui, Arcueil accueille de nombreuses entreprises et sièges sociaux. Nous avons une grande expérience dans le transfert de bureaux et d'équipements informatiques. Nous pouvons planifier l'opération le week-end ou en horaires décalés pour ne pas impacter votre activité." },
    ...
    <main className="bg-slate-50 min-h-screen selection:bg-[#00ad9f]/20 selection:text-[#00ad9f]">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-center bg-[#0b0f19] text-white pt-32 lg:pt-40 pb-20 overflow-hidden">
        <Image 
          ...
          alt="Quartier d'affaires moderne et dynamique"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          ...
          {/* Fil d'Ariane Intégré au Hero (Au-dessus du H1) */}
          <nav className="flex items-center text-[11px] font-black uppercase tracking-[0.2em] text-white/50 mb-8" aria-label="Breadcrumb">
            ...
            <ChevronRight className="h-3 w-3 mx-3 opacity-50" />
            <span className="text-[#00ad9f]">Arcueil</span>
          </nav>
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl font-light">
              La solution logistique efficace, rapide et professionnelle pour votre projet aux portes de Paris. Expertise dédiée pour les particuliers et transferts d'entreprises.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-8 relative z-10">
              ...
              <div className="space-y-5 text-lg text-slate-500 font-light leading-relaxed">
                ...
                <p>
                  Chez <strong>Déménagement du Vexin</strong>, nous avons l'expertise pour manœuvrer dans cet environnement. De l'aqueduc Médicis aux quartiers d'affaires de la Vache Noire, nous anticipons chaque détail (autorisations de voirie, horaires, déploiement de monte-meubles) pour vous offrir une journée sans le moindre accroc.
                </p>
              </div>
              ...
              <div className="pt-6 flex items-start gap-5">
                 ...
                 <div>
                   ...
                   <p className="text-slate-500 font-light">Des résidences anciennes aux grands pôles tertiaires récents.</p>
                 </div>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white bg-slate-100">
                <Image
                  src="/images/zones/demenagement-arcueil.webp"
      ...
      {/* --- WHY CHOOSE US --- */}
      <section id="why-us-arcueil" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
              ...
              <ul className="space-y-8">
                <li className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-light leading-relaxed">Mise en place de monte-meubles pour éviter les ascenseurs étroits et protéger les parties communes de votre immeuble.</p>
                  </div>
                </li>
                <li className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-light leading-relaxed">Déménagement d'entreprises (secteur Vache Noire), emballage du matériel informatique et travail en horaires décalés.</p>
                  </div>
                </li>
                <li className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-light leading-relaxed">De l'offre "Économique" pour maîtriser votre budget à la formule "Confort" où nous nous chargeons de tout emballer.</p>
                  </div>
                </li>
              </ul>
              <div className="pt-4">
      ...
      {/* --- FAQ --- */}
      <section id="faq-arcueil" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900">
              Questions <span className="text-[#00ad9f]">fréquentes</span>
            </h2>
            <p className="text-lg text-slate-500 font-light">Nos réponses pour une installation en toute sérénité.</p>
          </div>
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            {FAQS.map((item, i) => (
              <AccordionItem 
                value={`item-${i}`} 
                key={i} 
                className="bg-white border border-slate-200 rounded-2xl px-4 data-[state=open]:border-[#00ad9f]/30 data-[state=open]:shadow-md transition-all duration-300"
              >
