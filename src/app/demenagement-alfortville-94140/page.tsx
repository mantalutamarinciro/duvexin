...
const WHY_US_ITEMS = [
  {
    ...
    description: "Du centre-ville historique aux nouveaux quartiers, nous connaissons les rues, les accès et les plans de circulation."
  },
  {
    icon: Waves,
  ...
  },
  {
    ...
    description: "Nous déployons des solutions de levage (monte-meubles) et des véhicules adaptés aux rues parfois étroites de la ville."
  },
  {
    icon: ShieldCheck,
    title: "Sérénité Administrative",
    description: "Nous gérons pour vous les demandes d'autorisation de stationnement auprès de la mairie, une étape indispensable."
  }
];
  ...
  return (
    <main className="bg-slate-50 min-h-screen selection:bg-[#00ad9f]/20 selection:text-[#00ad9f]">
      ...
      <section className="relative min-h-[60vh] flex flex-col justify-center bg-[#0b0f19] text-white pt-24 pb-16 overflow-hidden">
        <Image 
          src="https://picsum.photos/seed/alfortville-seine/1920/1080"
          alt="Vue sur Alfortville et les bords de Seine au coucher du soleil"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          ...
          <nav className="flex items-center text-xs font-medium text-slate-400 mb-8" aria-label="Breadcrumb">
            ...
            <ChevronRight className="h-3 w-3 mx-2" />
            <span className="text-white">Alfortville</span>
          </nav>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-6 relative z-10">
              ...
              <p className="text-lg text-slate-500 leading-relaxed">
                Chez Marne Transdem, nous connaissons le terrain. Que vous emménagiez dans un appartement en plein centre-ville, dans une rue à sens unique ou sur les quais résidentiels, nous anticipons les difficultés (stationnement, portage, étages) pour vous garantir une journée parfaitement orchestrée.
              </p>
              ...
              <div className="pt-6 flex items-center gap-4">
                 ...
                 <div className="text-slate-900 font-bold text-lg">
                   Maîtrise du Secteur,<br/> <span className="text-slate-500 font-normal text-sm">des quais jusqu'au centre-ville.</span>
                 </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl border border-slate-100">
                <Image
                  src="https://picsum.photos/seed/alfortville-move-team/800/600"
                  alt="Équipe professionnelle en intervention près d'un fleuve urbain"
                  fill
      ...
      <section id="why-us-alfortville" className="py-20 lg:py-32 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <h2 className="text-3xl lg:text-5xl font-extrabold tracking-tight text-slate-900">
              Le bon choix pour Alfortville
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1 relative">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-xl border border-slate-100">
                <Image
                  src="https://picsum.photos/seed/alfortville-packing/800/600"
              ...
              <ul className="space-y-6 pt-2">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 mt-1 leading-relaxed">Passage maîtrisé dans les cages d'escalier, protection des parties communes et utilisation de monte-meubles jusqu'aux étages élevés.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-slate-900">Maisons & Bords de Marne</h4>
                    <p className="text-slate-500 mt-1 leading-relaxed">Nous gérons les emménagements en pavillon avec une logistique capable de s'adapter aux accès parfois restreints des quais.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="p-2 bg-slate-50 border border-slate-100 rounded-xl text-[#00ad9f] shrink-0 mt-1"><CheckCircle2 className="h-5 w-5"/></div>
                  <div>
                    ...
                    <p className="text-slate-500 mt-1 leading-relaxed">De la formule "Éco" pour petits budgets aux prestations clé en main où nous emballons toute votre vaisselle et vos livres.</p>
                  </div>
                </li>
              </ul>
              <div className="pt-4">
      ...
      {/* --- FAQ --- */}
      <section id="faq-alfortville" className="py-20 lg:py-32 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-extrabold tracking-tight text-slate-900">
              Questions <span className="text-[#00ad9f]">fréquentes</span>
            </h2>
            <p className="mt-4 text-lg text-slate-500">Nos réponses pour une installation en toute quiétude.</p>
          </div>
            ...
            <div className="relative rounded-[3rem] bg-[#0f172a] p-10 md:p-16 lg:p-24 text-center overflow-hidden shadow-2xl isolate">
               ...
               <div className="relative z-10">
                 <h2 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-8 leading-tight">
                    ...
                    <span className="text-[#00ad9f]">départ d'Alfortville ?</span>
                 </h2>
