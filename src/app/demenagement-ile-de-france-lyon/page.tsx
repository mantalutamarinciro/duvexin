...
const faqItems = [
    {
        ...
        answer: "Un déménagement entre l'Île-de-France et Lyon se déroule généralement sur deux jours. Le premier jour est consacré au chargement en région parisienne, et le second à la livraison et à l'installation à Lyon. Nous pouvons adapter ce planning à vos besoins."
    },
    {
        ...
        <div className="bg-background text-foreground">
            ...
            <section className="relative h-72 flex items-center justify-center text-center text-white">
                ...
                <div className="relative z-10 container">
                    ...
                    <h1 className="text-4xl md:text-5xl font-headline font-bold mt-2">Déménagement Île-de-France → Lyon</h1>
                    <p className="mt-4 text-lg max-w-3xl mx-auto text-white/90">La solution experte et fiable pour votre projet entre l'Île-de-France et la capitale des Gaules.</p>
                </div>
            </section>
            ...
            <section className="py-16">
                <div className="container grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl font-bold">Un déménageur francilien qui maîtrise la route de Lyon</h2>
                        ...
                        <p className="mt-4 text-muted-foreground">
                           Chez Déménagement du Vexin, nous sommes fiers de notre expertise sur l'axe Paris-Lyon. Nous réalisons de nombreux déménagements entre ces deux grandes métropoles et nous vous garantissons une prestation maîtrisée, depuis votre porte en Île-de-France jusqu'à votre nouveau domicile lyonnais.
                        </p>
                    </div>
                    <div>
                         <Image
            ...
            <section id="why-us-lyon" className="py-16 bg-muted/50">
                <div className="container">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-3xl font-bold">Le partenaire de confiance pour votre déménagement vers Lyon</h2>
                        <p className="mt-4 text-muted-foreground text-lg">Notre connaissance de l'axe Île-de-France - Lyon est la clé de votre tranquillité d'esprit.</p>
                    </div>
                         ...
                         <ul className="mt-6 space-y-4">
                            <li className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">Une expertise pour tous types de logements, avec des solutions de monte-meubles si nécessaire à l'arrivée à Lyon.</p>
                                </div>
                            </li>
                             <li className="flex items-start gap-4">
                                <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-1"/>
            ...
            <section id="faq-lyon" className="py-16">
                <div className="container max-w-4xl mx-auto">
                    <div className="text-center">
                        <h2 className="text-3xl font-bold">Questions fréquentes - Déménagement vers Lyon</h2>
                        <p className="mt-4 text-muted-foreground text-lg">Nos réponses claires pour un déménagement réussi vers la région lyonnaise.</p>
                    </div>
            ...
            <section id="contact-lyon" className="py-16 bg-primary/5">
                <div className="container text-center">
                    <h2 className="text-3xl font-bold">Organisez votre déménagement vers Lyon</h2>
