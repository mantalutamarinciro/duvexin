...
const WHY_US_ITEMS = [
  {
    ...
    description: "Du centre-ville aux vastes zones résidentielles, nous connaissons les rues, les sens uniques et les règles de stationnement."
  },
  {
    icon: Building,
    title: "Grands Ensembles",
    description: "Nos équipes ont l'habitude d'intervenir dans les grandes résidences et de gérer la logistique complexe des ascenseurs et couloirs."
  },
  {
    icon: Truck,
    title: "Matériel Adapté",
    description: "Si les accès sont restreints, nous déployons nos monte-meubles pour un passage par fenêtre rapide, discret et sécurisé."
  },
  {
    icon: Brush,
    ...
    <main className="bg-slate-50 min-h-screen selection:bg-[#00ad9f]/20 selection:text-[#00ad9f]">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-center bg-[#0b0f19] text-white pt-32 lg:pt-40 pb-20 overflow-hidden">
        <Image 
          ...
          alt="Déménageur professionnel en pleine intervention"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl font-light">
              La solution logistique efficace, locale et professionnelle pour votre projet à Vitry (94400), ville de dynamisme et de grands ensembles.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-8 relative z-10">
              ...
              <div className="space-y-5 text-lg text-slate-500 font-light leading-relaxed">
                <p>
                  Déménager à Vitry-sur-Seine, la plus grande ville du Val-de-Marne, demande une connaissance approfondie de son tissu urbain dense et varié. C'est une ville en pleine transformation, avec l'arrivée de nouvelles infrastructures, qui présente des défis logistiques que seuls des professionnels locaux peuvent relever avec brio.
                </p>
                <p>
                  Que vous emménagiez dans un appartement en centre-ville, un grand ensemble résidentiel ou un atelier d'artiste avec des accès complexes, <strong>Déménagement du Vexin</strong> planifie chaque détail pour garantir un déménagement fluide, rapide et sans le moindre stress.
                </p>
              </div>
              ...
              <div className="pt-6 flex items-start gap-5">
                 ...
                 <div>
                   <h3 className="text-xl font-bold text-slate-900 mb-1">Spécialiste Immeubles</h3>
                   <p className="text-slate-500 font-light">Maîtrise absolue des accès difficiles et de la logistique en étage.</p>
                 </div>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white bg-slate-100">
                <Image
                  src="/images/zones/demenagement-vitry-sur-seine.webp"
                  alt="Équipe professionnelle en intervention urbaine à Vitry"
                  fill
      ...
      {/* --- WHY CHOOSE US --- */}
      <section id="why-us-vitry" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="order-2 lg:order-1 relative group">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white bg-slate-100">
                <Image
                  ...
                  alt="Déménageur protégeant des objets d'art et du mobilier"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-105"
                />
              </div>
              ...
              <ul className="space-y-8">
                <li className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 font-light leading-relaxed">Passage délicat dans les cages d'escaliers, utilisation de monte-meubles jusqu'aux étages élevés et protection des parties communes.</p>
                  </div>
                </li>
                <li className="flex items-start gap-6">
                  <div className="p-4 bg-slate-50 border border-slate-100 shadow-sm rounded-2xl text-[#00ad9f] shrink-0"><Brush className="h-7 w-7"/></div>
                  <div>
                    <h4 className="text-xl font-bold text-slate-900 mb-2">Bureaux & Ateliers d'Artistes</h4>
                    <p className="text-slate-500 font-light leading-relaxed">Transfert d'équipements professionnels, de matériel informatique et d'œuvres fragiles avec un emballage premium sur-mesure.</p>
                  </div>
                </li>
                <li className="flex items-start gap-6">
      ...
      {/* --- FAQ --- */}
      <section id="faq-vitry" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900">
              Questions <span className="text-[#00ad9f]">fréquentes</span>
            </h2>
            <p className="text-lg text-slate-500 font-light">Nos réponses pour une installation en toute quiétude à Vitry.</p>
          </div>
               ...
               <div className="relative z-10 space-y-8">
                 ...
                 <div className="flex flex-col sm:flex-row justify-center gap-6 pt-6">
                    <Button size="lg" className="rounded-full h-16 px-10 text-lg font-bold bg-[#00ad9f] text-white hover:bg-[#009286] hover:scale-105 transition-all shadow-[0_20px_40px_-10px_rgba(0,173,159,0.4)]" asChild>
                       <Link href="/demande-devis">
                          Mon devis gratuit pour Vitry <ArrowRight className="ml-2 h-5 w-5" />
                       </Link>
                    </Button>
                 </div>
               </div>
