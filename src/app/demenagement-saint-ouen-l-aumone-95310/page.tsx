...
const WHY_US_ITEMS = [
  ...
  },
  {
    ...
    description: "Spécialiste du transfert industriel et tertiaire : Béthunes, Vert Galant et Épluches n'ont aucun secret pour nous."
  },
  {
    icon: Boxes,
    title: "Logistique Adaptée",
    description: "Flotte de véhicules variée et monte-meubles pour s'adapter aussi bien aux pavillons qu'aux bâtiments industriels."
  },
  {
    icon: ShieldCheck,
    title: "Sérénité Administrative",
    description: "Gestion complète des demandes d'autorisation de stationnement auprès de la mairie pour sécuriser le périmètre."
  }
];
...
const FAQS = [
  { 
    ...
    answer: "Nous réalisons un audit technique pour évaluer le volume (bureaux, serveurs, archives). L'intervention est planifiée pour minimiser l'arrêt de votre activité, souvent en horaires décalés ou durant le week-end." 
  },
  { 
    question: "Je déménage dans un pavillon, comment protégez-vous mon intérieur ?", 
    answer: "La protection est notre priorité. Nous installons des tapis de passage pour protéger vos sols et utilisons des protections spécifiques pour les angles de murs et les encadrements de portes." 
  },
  { 
    question: "Déménagez-vous sur de longues distances depuis Saint-Ouen-l'Aumône ?", 
    answer: "Oui, nous accompagnons nos clients partout en France et en Europe. Votre projet bénéficie de notre rigueur locale, que vous partiez pour la province ou l'étranger." 
  },
  { 
    question: "Proposez-vous des solutions de stockage temporaire ?", 
    answer: "Tout à fait. Si votre nouveau logement n'est pas prêt, nous disposons de garde-meubles sécurisés sous télésurveillance 24h/24 pour entreposer vos biens en toute sécurité." 
  }
];
  ...
  return (
    <main className="bg-slate-50 min-h-screen selection:bg-[#00ad9f]/20 selection:text-[#00ad9f]">
      ...
      <section className="relative min-h-[60vh] flex flex-col justify-center bg-[#0b0f19] text-white pt-24 pb-16 overflow-hidden">
        <Image 
          src="https://picsum.photos/seed/soa-95/1920/1080"
          alt="Saint-Ouen-l'Aumône, pôle économique du Val-d'Oise"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          <nav className="flex items-center text-xs font-medium text-slate-400 mb-8" aria-label="Breadcrumb">
            ...
            <ChevronRight className="h-3 w-3 mx-2" />
            <span className="text-white">Saint-Ouen-l'Aumône</span>
          </nav>
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl font-light">
              L'excellence logistique pour les particuliers et les entreprises du 95310. Une maîtrise parfaite des parcs d'activités et du cœur historique.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-6 relative z-10">
              ...
              <p className="text-lg text-slate-500 leading-relaxed">
                Saint-Ouen-l'Aumône est une ville aux multiples facettes, abritant l'un des plus grands parcs d'activités d'Europe. Déménager dans cet environnement exige une agilité technique capable de s'adapter aussi bien aux plateaux de bureaux tertiaires qu'aux pavillons familiaux verdoyants.
              </p>
              <p className="text-lg text-slate-500 leading-relaxed">
                Chez <strong>Déménagement du Vexin</strong>, nous maîtrisons chaque spécificité de la ville. Que vous emménagiez près de l'Abbaye de Maubuisson ou que vous transfériez votre siège social aux Béthunes, nous garantissons une transition fluide et sécurisée.
              </p>
              ...
              <div className="pt-6 flex items-center gap-4">
                 ...
                 <div className="text-slate-900 font-bold text-lg">
                   Expertise Patrimoine & Pro,<br/> <span className="text-slate-500 font-normal text-sm">maîtrise des accès urbains et des flux logistiques industriels.</span>
                 </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl border border-slate-100">
                <Image
                  src="https://picsum.photos/seed/soa-moving-team/800/600"
      ...
      {/* --- WHY CHOOSE US --- */}
      <section id="why-us-soa" className="py-20 lg:py-32 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-lg text-slate-500 font-light">
              Notre parfaite connaissance de Saint-Ouen-l'Aumône est votre meilleure garantie.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1 relative">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-xl border border-slate-100">
                <Image
                  src="https://picsum.photos/seed/soa-packing/800/600"
                  alt="Déménageur protégeant du matériel professionnel à Saint-Ouen-l'Aumône"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <ul className="space-y-6 pt-2">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 mt-1 leading-relaxed">Logistique dédiée aux zones industrielles : mobilier tertiaire, parcs informatiques et gestion d'archives.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
      ...
      {/* --- FAQ --- */}
      <section id="faq-soa" className="py-20 lg:py-32 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-extrabold tracking-tight text-slate-900">
              Questions <span className="text-[#00ad9f]">fréquentes</span>
            </h2>
            <p className="mt-4 text-lg text-slate-500 font-light">Tout savoir pour préparer votre installation réussie à Saint-Ouen-l'Aumône.</p>
          </div>
            ...
            <div className="relative rounded-[3rem] bg-[#0f172a] p-10 md:p-16 lg:p-24 text-center overflow-hidden shadow-2xl isolate">
               ...
               <div className="relative z-10">
                 <h2 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-8 leading-tight">
                    ...
                    <span className="text-[#00ad9f]">départ de Saint-Ouen ?</span>
                 </h2>
