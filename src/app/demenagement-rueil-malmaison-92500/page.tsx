...
const WHY_US_ITEMS = [
  ...
  },
  {
    ...
    description: "Une organisation rodée sur les grands axes pour garantir une ponctualité totale, y compris dans le nouvel éco-quartier."
  },
  {
    icon: ShieldCheck,
...
const FAQS = [
  { 
    ...
    answer: "Le centre ancien possède des rues parfois très étroites. Nous réalisons une étude d'accès pour choisir le véhicule idéal (petit porteur agile) et nous gérons l'arrêté municipal pour privatiser les places de stationnement nécessaires devant votre porte." 
  },
  { 
    question: "Intervenez-vous pour des transferts de sièges sociaux à Rueil 2000 ?", 
    answer: "Oui, c'est l'un de nos points forts. Nous accompagnons les entreprises de Rueil 2000 pour des transferts de bureaux, de parcs informatiques ou d'archives, avec une planification sur-mesure souvent réalisée le week-end pour éviter toute interruption d'activité." 
  },
  { 
    question: "Utilisez-vous un monte-meubles pour les résidences modernes ?", 
    answer: "Absolument. Que ce soit à l'Arsenal ou à Plaine-Gare, le monte-meubles extérieur sécurise votre mobilier volumineux, préserve les ascenseurs ou les parties communes des résidences neuves, et accélère considérablement l'opération." 
  },
  { 
    question: "Quel est le délai pour obtenir une visite technique à Rueil ?", 
    answer: "Grâce à notre présence constante dans le 92, nous pouvons intervenir sous 48h pour une visite à domicile (ou par visio) afin de vous transmettre un devis détaillé, ferme et définitif sous 24h ouvrées." 
  }
];
...
export default function RueilMalmaisonPage() {
  return (
    <main className="bg-slate-50 min-h-screen selection:bg-[#00ad9f]/20 selection:text-[#00ad9f]">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-center bg-[#0b0f19] text-white pt-32 lg:pt-40 pb-20 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          ...
          <nav className="flex items-center text-[11px] font-black uppercase tracking-[0.2em] text-white/50 mb-8" aria-label="Breadcrumb">
            ...
            <ChevronRight className="h-3 w-3 mx-3 opacity-50" />
            <span className="text-[#00ad9f]">Rueil-Malmaison</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-8 relative z-10">
              ...
              <div className="space-y-5 text-lg text-slate-500 font-light leading-relaxed">
                ...
                <p>
                  Chez <strong>Déménagement du Vexin</strong>, nous maîtrisons chaque spécificité du territoire rueillois. Que vous emménagiez dans une maison meulière à Buzenval ou que vous transfériez vos bureaux, nous planifions chaque détail logistique pour garantir une transition fluide.
                </p>
              </div>
              ...
              <div className="pt-6 flex items-start gap-5">
                 ...
                 <div>
                   <h3 className="text-xl font-bold text-slate-900 mb-1">Spécialiste Habitat Vert</h3>
                   <p className="text-slate-500 font-light">Maîtrise des accès pavillonnaires étroits et soin particulier de vos extérieurs.</p>
                 </div>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white bg-slate-100">
                <Image
                  src="/images/zones/demenagement-rueil-malmaison.webp"
      ...
      {/* --- WHY CHOOSE US --- */}
      <section id="why-us-rueil" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="order-1 lg:order-2 space-y-10 lg:pl-10">
              ...
              <ul className="space-y-8">
                <li className="flex items-start gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-slate-900 mb-2">Villas & Pavillons (Buzenval, Fouilleuse)</h4>
                    <p className="text-slate-500 font-light leading-relaxed">Logistique calibrée pour les grands volumes avec protection maximale des parquets, escaliers et mobilier précieux.</p>
                  </div>
                </li>
                <li className="flex items-start gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-slate-900 mb-2">Appartements & Résidences Neuves</h4>
                    <p className="text-slate-500 font-light leading-relaxed">Intervention soignée dans les immeubles denses de l'Arsenal ou Plaine-Gare avec gestion des accès complexes et monte-meubles.</p>
                  </div>
                </li>
                <li className="flex items-start gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-slate-900 mb-2">Transferts de Bureaux (Rueil 2000)</h4>
                    <p className="text-slate-500 font-light leading-relaxed">Services B2B dédiés : planification optimisée, transfert de parcs informatiques en toute sécurité et gestion d'archives.</p>
                  </div>
                </li>
              </ul>
              <div className="pt-4">
      ...
      {/* --- FAQ --- */}
      <section id="faq-rueil" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900">
              Questions <span className="text-[#00ad9f]">fréquentes</span>
            </h2>
            <p className="text-lg text-slate-500 font-light">Tout savoir pour préparer votre installation réussie à Rueil-Malmaison.</p>
          </div>
            ...
            <div className="relative rounded-[4rem] bg-[#0f172a] p-12 md:p-24 text-center overflow-hidden shadow-2xl isolate">
               ...
               <div className="relative z-10 space-y-8">
                 ...
                 <p className="text-xl text-slate-400 max-w-2xl mx-auto font-light leading-relaxed">
                    Ne laissez pas la logistique urbaine ou les contraintes d'accès freiner votre projet. Contactez nos experts pour une visite technique et obtenez un devis gratuit sous 24h.
                 </p>
