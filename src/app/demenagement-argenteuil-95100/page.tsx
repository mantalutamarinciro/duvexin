...
const WHY_US_ITEMS = [
  {
    ...
    description: "Du Val d'Argent aux Coteaux, nous connaissons chaque quartier et ses spécificités d'accès pour une logistique fluide."
  },
  {
    icon: Building,
  ...
  },
  {
    ...
    description: "Nous gérons pour vous les demandes d'autorisation de stationnement auprès de la mairie d'Argenteuil."
  }
];
...
const FAQS = [
  ...
  { question: "Comment protégez-vous les parties communes de mon immeuble ?", answer: "Nous protégeons systématiquement les zones de passage (ascenseurs, sols, couloirs) avec des tapis et protections adaptées pour éviter toute dégradation et respecter le règlement de votre copropriété." }
];
  ...
  return (
    <main className="bg-slate-50 min-h-screen selection:bg-[#00ad9f]/20 selection:text-[#00ad9f]">
      ...
      <section className="relative min-h-[60vh] flex flex-col justify-center bg-[#0b0f19] text-white pt-24 pb-16 overflow-hidden">
        <Image 
          src="https://picsum.photos/seed/argenteuil-city/1920/1080"
          alt="Vue urbaine et dynamique d'Argenteuil"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          <nav className="flex items-center text-xs font-medium text-slate-400 mb-8" aria-label="Breadcrumb">
            ...
            <ChevronRight className="h-3 w-3 mx-2" />
            <span className="text-white">Argenteuil</span>
          </nav>
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl font-light">
              La solution logistique experte pour les particuliers et les entreprises dans la ville la plus dynamique du Val-d'Oise (95100).
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-6 relative z-10">
              ...
              <div className="pt-6 flex items-center gap-4">
                 ...
                 <div className="text-slate-900 font-bold text-lg">
                   Expertise Urbaine,<br/> <span className="text-slate-500 font-normal text-sm">maîtrise des accès complexes du 95.</span>
                 </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl border border-slate-100">
                <Image
                  src="https://picsum.photos/seed/argenteuil-team/800/600"
      ...
      {/* --- WHY CHOOSE US --- */}
      <section id="why-us-argenteuil" className="py-20 lg:py-32 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-lg text-slate-500">
              La force d'un réseau national couplée à la connaissance fine du terrain local.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1 relative">
              ...
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-xl border border-slate-100">
                <Image
                  src="https://picsum.photos/seed/argenteuil-packing/800/600"
              ...
              <ul className="space-y-6 pt-2">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 mt-1 leading-relaxed">Protection totale des parties communes et déploiement de monte-meubles pour les étages élevés.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 mt-1 leading-relaxed">Logistique adaptée pour les gros volumes des Coteaux ou du quartier d'Orgemont.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 mt-1 leading-relaxed">De la formule "Économique" au service tout confort, vous choisissez votre degré d'implication.</p>
                  </div>
                </li>
              </ul>
              <div className="pt-4">
      ...
      {/* --- FAQ --- */}
      <section id="faq-argenteuil" className="py-20 lg:py-32 bg-slate-50">
            ...
            <div className="relative rounded-[3rem] bg-[#0f172a] p-10 md:p-16 lg:p-24 text-center overflow-hidden shadow-2xl isolate">
               ...
               <div className="relative z-10">
                 <h2 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-8 leading-tight">
                    ...
                    <span className="text-[#00ad9f]">départ d'Argenteuil ?</span>
                 </h2>
